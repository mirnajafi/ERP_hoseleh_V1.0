    ...
    const tabItems = [
        {
            label: "اطلاعات فردی", content:
                <div>
                    ...
                    <div className="w-full xl:py-2  my-0 flex flex-col xl:flex-row xl:justify-end">
                        <Input
        ...
        },
        {
            label: "تشخیص ارزیاب", content:
                <div>
                    <InformationUserBox name="زهرا" age="23" phoneNumber={9369491942} evaluator="دکتر حوصله" imageSrc={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-3afJuXe5nCNIn9j5xfMQZ4Ov3ObgCY9w4PjCXHJivkldezhENEs-W2L6sWvFiT-ae-w&usqp=CAU"} />
                </div>
        },
