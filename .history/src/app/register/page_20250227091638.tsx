...
const register = () => {
    ...
    const tabItems = [
        ...
        { label: "تشخیص ارزیاب", content: <div>
            ...
            <InformationUserBox name="زهرا" age="23" phoneNumber={9369491942} evaluator="دکتر حوصله" imageSrc={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwgT2eHovk83Kd0D870HAoiPDi4IQLN9jQjg&s"}/>
        </div> },
