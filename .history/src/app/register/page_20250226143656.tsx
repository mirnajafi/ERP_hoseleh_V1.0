    ...
    const tabItems = [
        {
            label: "اطلاعات فردی", content:
                <div>
                    ...
                    <div className="w-full xl:py-2 my-0 flex fl                    <div className="w-full xl:py-2 my-0  flex flex-col xl:flex-row xl:justify-center xl:items-end">
ex-col xl:flex-row xl:items-end xl:justify-center">
                        <Input
                            label="رشته ورزشی"
                            type="text"
                            value={''}
