    ...
    const tabItems = [
        ...
        },
        {
            label: "تشخیص ارزیاب", content:
                <div>
                    <InformationUserBox name="زهرا" age="23" phoneNumber={گ9369491942} evaluator="دکتر حوصله" imageSrc={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-3afJuXe5nCNIn9j5xfMQZ4Ov3ObgCY9w4PjCXHJivkldezhENEs-W2L6sWvFiT-ae-w&usqp=CAU"} />
                </div>
        },
