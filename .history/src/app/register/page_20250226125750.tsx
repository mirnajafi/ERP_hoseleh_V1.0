...
const register = () => {
    ...
    const tabItems = [
        { label: "اطلاعات فردی", content: <div> <div className="w-full py-2 my-2 flex flex-col xl:flex-row">
            <Dropdown
                label="نام باشگاه"
        ...
        <div className="w-full py-2 my-2 flex flex-col xl:flex-row">
            <Input
        ...
        <div className="w-full py-2 m-2 flex flex-col xl:flex-row">
            <Dropdown
