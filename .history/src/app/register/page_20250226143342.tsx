    ...
    const tabItems = [
        {
            label: "اطلاعات فردی", content:
                <div>
                    ...
                    <div className="w-full xl:py-2 my-0  flex flex-col xl:flex-row xl:justify-center xl:items:center">
                        <Dropdown
                    ...
                    <div className="w-full  xl:py-2 my-0 flex flex-col xl:flex-row xl:items-center xl:justify-start">
                        <Input
                            label="رشته ورزشی"
                            type="text"
                            value={''}
