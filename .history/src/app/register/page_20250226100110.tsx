        ...
        <div className="w-full flex flex-col">
            ...
            <div className="w-full p-2 m-2 flex flex-col xl:flex-row">
                ...
                <Input
                    ...
                    placeholder="مثال:تعویض مفصل زانو"
                />
                <InputDate label='تاریخ جراحی' valueDay="روز" valueMonth="ماه" valueYear="سال" onChange={() => { } } placeholderDay={"روز"} placeholderMonth={"ماه"} placeholderYear={""} />
            ...
            <div className="w-full p-2 m-2 flex flex-col xl:flex-row">
                <Dropdown
                    ...
                    onSelect={handleSelect}
                />
                <InputDate label='' valueDay="" valueMonth="" valueYear="" onChange={() => { }} />
                <Input
                    label="توضیحات"
                    type="text"
                    value={''}
