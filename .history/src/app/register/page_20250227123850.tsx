        ...
        },
        {
            label: "تشخیص ارزیاب", content:
                <div>
                    ...
                    <button className="bg-[#FFF6F7] h-10 w-10 border rounded-lg border-[#FF7101] flex justify-center items-center"><Tra width={25} height={25}/></button>
                    <button className="bg-[#FFF6F7] h-10 w-10 border rounded-lg border-[#FF7101] flex justify-center items-center"><UploaderIcon width={25} height={25}/></button>
