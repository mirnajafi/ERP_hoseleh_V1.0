...
const register = () => {
    ...
    const tabItems = [
        ...
        { label: "تشخیص ارزیاب", content: <div>
            ...
            <InformationUserBox name="زهرا" age="23" phoneNumber={9369491942} evaluator="دکتر حوصله" imageSrc={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUbq3IrAVvxyjg_WQIhKZOBrq8X_H_91GlvSNjo1rxCSj3839RR3hsDWxPQaIMO1amuyM&usqp=CAU"}/>
        </div> },
