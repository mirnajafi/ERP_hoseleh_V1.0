  ...
  return (
    <div className={`w-full xl:w-1/5 ml-3 max-w-[200px] ${className}`}>
      ...
      <input
        ...
        required={required}
        className="block w-full p-2  max-w-200 text-s border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
      />
    </div>
  );
};
