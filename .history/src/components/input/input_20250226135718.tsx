...
const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className={`w-full xl:w-1/5 ml-3 my-2 max-w-[200px] ${className}`}>
      <label className="block text-xs text-gray-700 mt-4 xl:mt-2 mb-2 font-bold font-bold">{label}</label>
