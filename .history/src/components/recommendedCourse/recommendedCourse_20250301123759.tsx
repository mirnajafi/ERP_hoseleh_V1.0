        ...
        <div className={'w-full flex flex-col lg:flex-row containLeftSideBox text-xs '}>
            <div className="flex flex-col mr-4">
                ...
                <div className="flex flex-col justify-center items-start  mt-2">
                    <span className="ml-10 flex flex-row-reverse w-full">تعداد کل جلسات:  <div className="bg-[#4CAF50] rounded-[8px]">6</div></span>
                    <span className="ml-10 flex flex-row-reverse w-full">تعداد ماه:{ }</span>
                    <span className="ml-10 flex flex-row-reverse w-full">تعداد جلسه در هفته:{ }</span>
