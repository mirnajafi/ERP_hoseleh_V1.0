    ...
    return (
        <div className={'w-full flex flex-col lg:flex-row-reverse text-xs bg-[#4CAF501A] rounded-[8px] mt-4 p-5'}>
            <div className="flex flex-col mr-4">
                <div className="font-bold flex flex-row items-center special-margin"><CircleIcon fillColor="#4CAF50" width={10} height={10} /> {title}</div>
                ...
                <div className="font-bold flex flex-row items-center special-margin"><CircleIcon fillColor="#4CAF50" w width={10} height={10} /> {title}</div>
                <div className="flex flex-col justify-center items-start  mt-2">
