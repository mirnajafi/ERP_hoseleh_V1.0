        ...
        <div className={'w-full flex flex-col lg:flex-row-reverse text-xs bg-[#4CAF501A] rounded-[8px] mt-4 p-5'}>
            <div className="flex flex-col mr-4">
                ...
                <div className="flex flex-col  border-r border-[#4CAF50]">
                    <span className="ml-10 flex flex-row-reverse w-full justify-between">تعداد کل جلسات:  <div className="bg-[#4CAF50] rounded-[8px] text-white">6</div></span>
                    <span className="ml-10 flex flex-row-reverse w-full justify-between">تعداد ماه: <div className="bg-[#4CAF50] rounded-[8px] text-white">6</div></span>
                    <span className="ml-10 flex flex-row-reverse w-full justify-between">تعداد جلسه در هفته: <div className="bg-[#4CAF50] rounded-[8px] text-white">6</div></span>
