    ...
    return (
        <div className={'w-full flex flex-col lg:flex-row-reverse text-xs bg-[#4CAF501A] rounded-[8px] mt-4 p-5'}>
            <div className="flex flex-col mr-4">
                ...
                <div className="font-bold flex flex-row items-center special-margin"><CircleIcon fillColor="#4CAF50" color="white" width={10} height={10} /> {title}</div>
                <div className="flex flex-wrap justify-start items-center mt-2 gap-1 text-xs">
                    <span className="bg-white rounded-[8px] p-2">فاطمه </span>
                    <span className="bg-white rounded-[8px] p-2"> یوسفی</span>
                    <span className="bg-white rounded-[8px] p-2">فاطمه یوسفی</span>
                </div>
