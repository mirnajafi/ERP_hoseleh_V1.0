    ...
    return (
        <div className="flex items-center justify-between w-full  pb-2">
            ...
            <div className="flex items-center gap-4 w-full ">
                ...
                <button className="text-sm flex flex-row items-center justify-center" onClick={onEdit}>
                    

                    <svg width="14" height="14" viewBox="0 0 23 23" className='ml-2 text-[#798BA5]' fill="none" xmlns="http://www.w3.org/2000/svg">
