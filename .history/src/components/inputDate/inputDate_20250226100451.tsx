    ...
    <div className={`w-full xl:w-1/5 ml-3 max-w-[200px]  ${className}`}>
      ...
      <div className="flex flex-row">
        ...
        <input
          ...
          required={required}
          className="block w-full p-2 m-2 max-w-200 text-xs border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        />
      </div>
    </div>
  );
