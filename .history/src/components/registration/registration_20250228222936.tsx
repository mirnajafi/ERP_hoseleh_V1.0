    ...
    return (
        <div>
            <div className="w-full flex flex-row">
                <InformationUserBox name="حانیه دانیال" age="23" phoneNumber={'9369491942'} evaluator="دکتر حوصله" debt="25000" imageSrc="/images/defaultUser.png" className="w-1/2" />
                <ResultBox resultText={"حانیه دانیال نیاز به برنامه بازتوانی acl دارد"} className="w-1/2" />
            </div>


            
            <div className="flex flex-row  my-4 items-center">
                <label className="mb-2 text-xs font-bold text-gray-700 ml-2">برنامه </label>
