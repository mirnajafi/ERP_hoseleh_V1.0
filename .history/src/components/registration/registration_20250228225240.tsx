    ...
    return (
        <div>
            <div className="w-full flex flex-row">
                <InformationUserBox name="حانیه دانیال" age="23" phoneNumber={'9369491942'} evaluator="دکتر حوصله" debt="25000" imageSrc="/images/defaultUser.png" className="w-1/2 lg:ml-" />
