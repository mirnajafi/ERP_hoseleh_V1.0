                ...
                <div className="w-full flex flex-col">
                    ...
                    <div className="flex flex-row items-start">
                        <div className="flex flex-col m-2">
                            <div className="flex flex-row border border-[#FFA466] p-[8px] bg-[#FEE8D82B] rounded-[8px] text-xs"><span>مبلغ کلاس و خدمات:</span><span className="font-bold mr-4">7,800,000 ریال</span></div>
                            <span className="text-grey-100 text-xs">هفتصد هزار تومان</span>
                        </div>
                        <Dropdown
                            label="درصد تخفیف"
                            options={["گزینه 1", "گزینه 2", "گزینه 3"]}
