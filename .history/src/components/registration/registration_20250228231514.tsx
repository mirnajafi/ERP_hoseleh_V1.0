        ...
        <div>
            ...
            <div className="flex flex-row">
                ...
                <div className="w-1/6 p-2 flex flex-col">
                    <button className="bg-[#3B3E4B] text-white p-4 w-full border rounded-[8px] ">نمایش دوره‌ها</button>
                    <button className="bg-transparent text-[#007F63] text-white p-4 w-full border-2 border-[#007F63] rounded-[8px] flex items-center justify-center font-bold"><PlusIcon width={30} height={30}/> ثبت دوره جدید</button>
