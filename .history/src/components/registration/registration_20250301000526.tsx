            ...
            <div className="w-full flex flex-row">
                ...
                <div className="w-full flex flex-col">
                    ...
                    <div className="flex flex-col">
                        <div className="flex flex-row border border-[#FFA466] p-[8px] bg-[#FEE8D82B] rounded-[8px]"><span>مبلغ کلاس و خدمات:</span><span className="font-bold mr-2">7,800,000 ریال</span></div>
