...
const Dropdown: React.FC<DropdownProps> = ({ label, options, onSelect }) => {
    ...
    return (
        <div className="relative inline-block text-left w-full xl:w-1/5 ml-3">
            ...
            <button
                type="button"
                className="inline-flex justify-between items-center w-full max-w- p-2 rounded-md border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
