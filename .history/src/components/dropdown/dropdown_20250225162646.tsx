...
const Dropdown: React.FC<DropdownProps> = ({ label, options, onSelect }) => {
    ...
    return (
        <div className="relative inline-block text-left w-full max-w-100 xl:w-1/5 ml-3">
            <label className="block text-sm font-medium text-gray-700 mb-2 text-right  font-bold">{label}</label>
