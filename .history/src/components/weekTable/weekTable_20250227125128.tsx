          ...
          <tr>
            {weekDays.map((item, index) => (
              <td key={index} className="border px-4 py-2 text-center">
                ...
                <div className="mt-2 bg-[#729FFE] p-2 flex flex-col text-white items-start rounded-[8px]">
                  <input
                    type="radio"
                    name="weekDay"
                    value={item.day}
                  ...
                  <span className="text-white ">نام برنامه: بازتوانی ACL</span>
                  <span className="text-white ">سطح برنامه: A2</span>
                </div>
              </td>
            ))}
          </tr>
